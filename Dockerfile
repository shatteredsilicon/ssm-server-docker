...
RUN microdnf -y --enablerepo ssm --enablerepo ssm-9.4 --enablerepo ssm-snmp-exporter --enablerepo shatteredsilicon-mariadb-10.4 --enablerepo percona-pt-release install ssm-meta-9.4.22
