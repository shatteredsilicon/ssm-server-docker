...
RUN microdnf -y --enablerepo ssm --enablerepo ssm-9.5 --enablerepo ssm-prometheus --enablerepo shatteredsilicon-mariadb-10.4 --enablerepo percona-pt-release install ssm-meta-9.5.0
